...
- **REQ-135~142「方案 only」批次已实现交付（2026-09-24，主人授权转入开发；01 v0.35）**：REQ-135 配置分级/REQ-136 自动命名/REQ-137 logo/REQ-139 卡片优化/REQ-140 文档查看（代码）；REQ-141 调研（21 号）/REQ-142 研究（22 号）文档落档；REQ-143/144（对话对比扩展）已立项方案 only，待下轮开发。
