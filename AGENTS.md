...
- **M10 阶段 10a+10b 代码均已交付；10b 文档回写待领取**：10a 实测交付（96210e6，2026-09-25，主人装 Docker 后领取）；**10b 沙箱生命周期可见化+资源限制参数化代码已交付（9b0d45c，迁移 020——此前 02 §12 误记"进行中"，v0.68 已顺修；01/17/20 的 10b 交付回写与冒烟注记仍待领取**，领取时先 git log 9b0d45c 核对实现再回写）。
