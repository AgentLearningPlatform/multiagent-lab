...
| 01-研究报告-智能体运行时动态本体的可行性与方案.md | 主人引入源文档（MLSys 2026 论文核心可行性研究）；external-resources §6.A 子课题源 |
| 02-资料合集-动态本体与智能体记忆.md | 主人引入源文档（30+ 篇文献合集：记忆系统/图检索/动态 schema/时序图谱/评测基准） |
| 智能体运行时动态薄本体可行方案_20260925.md | 动态薄本体落地方案（报告轻量档 × D-O15 自研栈，旁路低侵入；REQ-169+ 立项建议待拍板） |
